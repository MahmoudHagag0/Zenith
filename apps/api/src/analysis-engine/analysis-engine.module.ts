 ...
 * S1-013/S1-014/S1-015/S1-016/S1-017/S1-018 — the nine real Analysis
 ...
 * `SupplyDemandProvider`/`FibonacciAnalysisProvider`/`VsaProvider` with
 ...
 * imports it — only the reverse). A future Provider is added the same
 * way: a concrete class plus an entry in this factory's `inject` array,
 * never by editing any existing Provider's own code.
 *
