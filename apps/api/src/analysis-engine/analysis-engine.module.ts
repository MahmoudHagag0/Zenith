 ...
 * S1-013/S1-014 — the five real Analysis Providers, and S1-012 — the
 * Confluence Engine (methodology-family-aware, dimension-level
 ...
 * `ClassicalChartPatternsProvider` with the same shared
